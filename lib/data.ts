...
export type CriterionState = "met" | "not-met" | "not-found";
...
export function flattenDecisionTree(tree: DecisionTree): Criterion[] {
    const walk = (items: Criterion[]): Criterion[] =>
        items.flatMap((c) => [c, ...(c.children ? walk(c.children) : [])]);
    return [...walk(tree.inclusion), ...walk(tree.exclusion)];
}
...
export interface AppealRequest {
    ...
    confidence: number;
    recommendation: string;
    recommendationVerdict: "NOT APPROVE" | "APPROVE" | "PENDING";
...
export const appealsData: Omit<AppealRequest, "cycles" | "events">[] = [
    {
        ...
        rationale: [
            {
                ...
                detail: "Clinical policy CMS-L33747 requires at least 12 weeks of documented conservative management (physical therapy, NSAIDs, and activity modification). Submitted records only confirm 6 weeks of PT.",
                reference: "PT_Records_V2.pdf",
            },
            {
                title: "Missing Imaging Correlation",
                detail: "Radiographic findings must correlate with the clinical diagnosis of spondylolisthesis grade II or higher. MRI report dated 08/15/23 notes 'mild degenerative changes' but does not specify grading.",
            },
            {
                title: "Tobacco Cessation Requirement",
                detail: "For elective spinal fusion, policy requires a 6-week tobacco-free period. Patient chart indicates active smoking status as of last visit (10/02/23).",
            },
        ],
        ...
        evidence: [
            ...
            },
            {
                ...
                change: "insufficient",
                changeNote:
                    "Only 6 weeks of PT documented — gap filled by appeal PT logs.",
                        ...
                        children: [
                            {
                                ...
                                state: "not-met",
                                evidence:
                                    "Only 3 months of PT documented in initial submission.",
                            },
                            {
                                id: "A.2.2",
                                ...
                                state: "not-met",
                                evidence:
                                    "No record of epidural steroid injections.",
                            },
                            {
                                id: "A.2.3",
                                label: "Pharmacologic Management",
                                description:
                                    "Documented trial of NSAIDs or analgesics.",
                                state: "met",
        ...
        determinationIssue: {
            ...
            detail: "has not been satisfied. The medical policy requires a minimum of 6 months trial of conservative therapy unless contraindicated.",
        },
        appeal: {
            decision: "Approved",
            decisionDate: "Apr 05",
            ...
            evidence: [
                ...
                },
                {
                    ...
                    change: "new",
                    changeNote:
                        "Supporting letter — not in original submission.",
                    preview:
                ...
                },
                {
                    ...
                    change: "updated",
                    changeNote:
                        "Full 16-week PT logs — supersedes incomplete PT_Records_V2.pdf.",
                ...
                },
                {
                    ...
                    change: "new",
                    changeNote:
                        "Pharmacy history — not in original submission.",
                    preview:
                ...
                },
                {
                    ...
                    change: "new",
                    changeNote:
                        "ESI documentation — missing from original submission.",
                    preview:
            ...
            criteria: [
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            state: "met",
                            evidence:
                                "Evidence Source: Dr. Aris Med Record (System ID: 99102-B)",
                            children: [
                                {
                                    id: "A.2.1",
                                    label: "Physical Therapy (6 months)",
                                    ...
                                    state: "met",
                                    evidence:
                                        "PT logs Oct–Jan confirm 16 weeks of therapy (Exhibit A).",
                                },
                                {
                                    id: "A.2.2",
                                    label: "Epidural Steroid Injection",
                                    ...
                                    state: "met",
                                    evidence:
                                        "ESI performed Feb 10, 2023 (Exhibit B).",
                                },
                                {
                                    id: "A.2.3",
                                    label: "Pharmacologic Management",
                                    ...
                                    state: "met",
                                    evidence:
                                        "Pharmacy records confirm NSAID regimen (Exhibit C).",
                                },
                            ],
                        },
                        {
    ...
    },
    {
        ...
        rationale: [
            {
                ...
                detail: "Documentation shows only a 2-week trial of Metoprolol. Policy requires a minimum 30-day trial of beta-blockers or calcium channel blockers unless contraindicated.",
            },
            {
                title: "REMS Enrollment Confirmed",
                detail: "REMS program enrollment confirmed. Baseline LVEF recorded at 62%, meeting the ≥55% safety threshold.",
            },
        ],
                ...
                children: [
                    {
                        ...
                        description:
                            "Patient exhibits symptoms consistent with Class II or III.",
                        state: "met",
                    ...
                    },
                    {
                        ...
                        state: "not-met",
                        evidence:
                            "Documentation shows only 2 weeks trial of Metoprolol.",
                    },
                ],
            },
            {
                ...
                description:
                    "Required baseline screenings and ongoing safety commitments.",
                state: "met",
                ...
                children: [
                    {
                        ...
                        description:
                            "Baseline LVEF must be greater than or equal to 55%.",
                        state: "met",
        ...
        determinationIssue: {
            ...
            detail: "has not been satisfied. The medical policy requires a minimum of 30 days trial for first-line therapies unless contraindicated.",
        },
        appeal: {
            decision: "Denied",
            decisionDate: "Nov 18",
            ...
            evidence: [
                {
                    ...
                    change: "new",
                    changeNote:
                        "Level 1 appeal letter — not in original submission.",
                },
                {
                    ...
                    change: "updated",
                    changeNote:
                        "Extended records still show only 21-day Metoprolol trial.",
                ...
                },
                {
                    ...
                    change: "new",
                    changeNote:
                        "Physician letter — does not establish 30-day trial or intolerance.",
                },
            ],
            criteria: [
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            state: "not-met",
                            evidence:
                                "Extended pharmacy records confirm Oct 1–21 only.",
                        },
                    ],
                },
                {
    ...
    },
    {
        ...
        rationale: [
            {
                ...
                detail: "Policy requires documented failure of, or contraindication to, first-line chemoimmunotherapy (R-CHOP or equivalent). Treatment summary lists diagnosis only; no infusion dates or response assessment.",
            },
            {
                title: "Histology Confirmed",
                detail: "Pathology confirms CD20-positive follicular lymphoma grade 2. Diagnosis criterion is met.",
            },
        ],
        ...
        criteria: [
            {
                ...
                label: "Inclusions & Diagnosis",
                description:
                    "Confirmed CD20-positive B-cell non-Hodgkin lymphoma.",
                state: "met",
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        description:
                            "Relapse or inadequate response after first-line therapy.",
                        state: "not-met",
        ...
        determinationIssue: {
            ...
            detail: "has not been satisfied. Policy requires documented prior R-CHOP or equivalent before second-line Rituximab.",
        },
        appeal: {
            decision: "In Review",
            ...
            evidence: [
                ...
                },
                {
                    ...
                    change: "new",
                    changeNote:
                        "Chemo infusion dates — may address prior therapy gap.",
                ...
                },
                {
                    ...
                    change: "new",
                    changeNote:
                        "Progress note documenting relapse after first-line therapy.",
                },
            ],
            criteria: [
                {
                    ...
                    children: [
                        {
                            ...
                            label: "First-Line Chemoimmunotherapy",
                            description:
                                "Appeal infusion records show 6 R-CHOP cycles Jun–Sep 2023.",
                            state: "met",
                            evidence:
                                "Pending verification against infusion logs (Exhibit A).",
                        },
                        {
                            id: "B.2",
                            label: "Progression or Intolerance",
                            description:
                                "PET restaging suggests progression — under review.",
                            state: "not-met",
    ...
    },
    {
        ...
        drug: "Dupixent",
        policyName: "DERM-2023-08 — Moderate-to-Severe Atopic Dermatitis",
        payerName: "BlueCross BlueShield TX",
        status: "Approved",
        lastUpdated: "Nov 22, 2023 · 02:45 PM",
        submitted: "Nov 02, 2023 · 08:30 AM",
        denialDate: "Oct 18",
        originalReviewDate: "Oct 18, 2023",
        ...
        rationale: [
            {
                title: "Severity Criteria Met",
                detail: "Dermatology note documents EASI 22 and BSA 18% at appeal submission.",
                reference: "Derm_Assessment_Nov02.pdf",
            },
            {
                title: "Prior Topical Therapy Documented",
                detail: "Pharmacy and clinic records confirm 8-week high-potency topical steroid trial with inadequate response.",
            },
        ],
        policyCodes: ["J-Code J3590", "ICD-10 L20.89"],
        policyFile: "DERM-2023-08_Atopic_Dermatitis.pdf",
        policyRef: "Policy #DERM-2023-08",
        policyGuideline:
            "Biologic therapy for moderate-to-severe atopic dermatitis when topical therapies fail.",
        policyVersion: "v1.3 Last Update: Sep 08, 2023",
        evidence: [
            {
        ...
        patient: {
            ...
            address: "1842 Cedar Park Ln, Dallas, TX",
        },
        provider: {
            name: "Dr. Priya Nair, MD",
            email: "p.nair@dermassociates.com",
            address: "880 Medical Pkwy, Dallas, TX",
            npi: "1629348571",
        },
        reviewer: {
            name: "James Okonkwo",
            org: "Reviewer Organization A",
            email: "j.okonkwo@revieworg.com",
        },
        requestingMd: "Dr. Priya Nair, MD",
        criteria: [
            {
                id: "A",
                label: "Atopic Dermatitis Severity",
                description: "Moderate-to-severe disease documented.",
                state: "met",
                evidence: "EASI 22 documented.",
            },
        ],
    },
    {
        ...
        payerName: "Aetna",
        status: "Missing Info",
        lastUpdated: "Nov 20, 2023 · 09:10 AM",
        submitted: "Nov 10, 2023 · 01:15 PM",
        denialDate: "Nov 01",
        ...
        rationale: [
            {
                title: "Pain Diary Not Submitted",
                detail: "Policy requires a minimum 4-week pain diary prior to SCS trial. Appeal package includes implant referral only.",
            },
            {
                title: "Failed Conservative Therapy Documented",
                detail: "PT and medication trials are on file and meet policy requirements.",
            },
        ],
        policyCodes: ["CPT 63650", "ICD-10 M54.16"],
        policyFile: "NEURO-2022-15_SCS.pdf",
        policyRef: "Policy #NEURO-2022-15",
        policyGuideline:
            "Spinal cord stimulation trial criteria for chronic intractable pain.",
        policyVersion: "v2.0 Last Update: Aug 14, 2023",
        evidence: [
            {
        ...
        patient: {
            ...
            address: "902 Lakeview Rd, Houston, TX",
        },
        provider: {
            name: "Dr. Alan Brooks, MD",
            email: "a.brooks@painclinic.com",
            address: "1200 Pain Center Way, Houston, TX",
            npi: "1982736450",
        },
        reviewer: {
            name: "Karen Highland",
        ...
        requestingMd: "Dr. Alan Brooks, MD",
        criteria: [
            {
                id: "A",
        ...
        determinationIssue: {
            requirement: "A.2 (4-Week Pain Diary)",
            detail: "has not been submitted. Request additional documentation from provider.",
        },
    },
    {
        id: "ag-441203",
        ...
        policyGuideline:
            "Advanced imaging guidelines for musculoskeletal indications.",
        ...
        provider: {
            name: "Dr. Kevin Park, MD",
            email: "k.park@orthotex.com",
            address: "4500 Fannin St, Houston, TX",
            npi: "1748293012",
        },
        reviewer: {
            name: "Karen Highland",
...
export function getAppeal(id: string) {
    return appeals.find((r) => r.id === id);
}
