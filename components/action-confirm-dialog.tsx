...
export function ActionConfirmDialog({
    ...
    const confirmDisabled =
        needsLetter && (phase === "generating" || !draftLetter);
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-6 py-4">
                    {needsLetter ? (
                            ...
                            {phase === "generating" ? (
                                <div className="flex flex-col items-center justify-center gap-4 py-10 text-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs text-muted-foreground">
                                            Generating AI summary and
                                            correspondence from the appeal
                                            record
                                        </p>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Accept this letter to record the{" "}
                                        {action.label.toLowerCase()} decision on
                                        the appeal timeline.
                                    </p>
                                </div>
                            ) : null}
                        ...
                        <p className="text-xs text-muted-foreground">
                            This will be recorded on the appeal timeline for the
                            active level.
                        </p>
                    )}
                </div>
